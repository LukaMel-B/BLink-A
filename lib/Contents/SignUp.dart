                  ...
                  child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(top: 50,bottom: 5,left: 50,right: 50),
                                    child: TextField(
                                        ...
                                        child: TextButton(
                                          ...
                                          child: const Padding(
                                            padding: EdgeInsets.only(
                                                left: 10, right: 10, bottom: 13, top: 13),
                                            child: Text(
                                              'Student',
                                              style: TextStyle(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(top: 18,bottom: 25, right: 15),
                                        child: TextButton(
                                          onPressed: () {
